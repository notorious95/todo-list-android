...
public class HistoryTaskFragment extends Fragment implements CustomCursorAdapter.ListClickListener, LoaderManager.LoaderCallbacks<Cursor> {

    private CustomCursorAdapter mAdapter;
    private RecyclerView mRecyclerView;
    private FloatingActionButton mFloatingButton;

    private static final String TAG = "HISTORY_TASK_FRAGMENT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFloatingButton.setOnClickListener(view -> {
            ...
            int result = mResolver.delete(uri, "datetime<?", new String[]{String.valueOf(String.valueOf(mDateToday.getTime()))});
            if (result > 0){
                Toast.makeText(mainActivityContext, "History has been deleted.", Toast.LENGTH_SHORT).show();
                loaderManager.restartLoader(TASK_LOADER_ID, null, this);
            } else
        ...
        return new AsyncTaskLoader<Cursor>(mainActivityContext) {
            ...
            public Cursor loadInBackground() {
                ...
                try {
                    ...
                    try {
                        mDateToday = dateFormat.parse(today);
                    ...
                    return mResolver.query(TaskContract.Tasks.CONTENT_URI,
                            null,
                            "datetime<?",
                            new String[]{String.valueOf(String.valueOf(mDateToday.getTime()))},
                            TaskContract.Tasks.COLUMN_DATETIME + " DESC, " + TaskContract.Tasks.COLUMN_PRIORITY);
                } catch (Exception e) {
