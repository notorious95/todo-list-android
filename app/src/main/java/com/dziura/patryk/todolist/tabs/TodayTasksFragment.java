...
public class TodayTasksFragment extends Fragment implements CustomCursorAdapter.ListClickListener, LoaderManager.LoaderCallbacks<Cursor> {

    private CustomCursorAdapter mAdapter;
    private RecyclerView mRecyclerView;
    private FloatingActionButton mFloatingButton;

    private static final String TAG = "TODAY_TASKS_FRAGMENT";
        ...
        return new AsyncTaskLoader<Cursor>(mainActivityContext) {
            ...
            public Cursor loadInBackground() {
                ...
                try {
                    ...
                    try {
                        dateToday = dateFormat.parse(today);
                    ...
                    return mResolver.query(TaskContract.Tasks.CONTENT_URI,
                            ...
                            new String[]{String.valueOf(dateToday.getTime()), String.valueOf(dateTommorow.getTime())},
